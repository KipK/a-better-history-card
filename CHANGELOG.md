...
- update ha-better-history lib to 0.1.7
 . fix climate overlay position
 . fix attribute picker not closing when clicking on top

## [0.1.2]

- updated ha-better-history-component to 0.1.8
  . better UX on mobile
