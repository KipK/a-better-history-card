export const NAME = "A Better History Card";
...
export const BUTTON_CARD_TAG = "a-better-history-button-card";
export const BUTTON_EDITOR_TAG = "a-better-history-button-card-editor";
