...
var Te = class {
	...
	_$AI(e, t = this) {
		e = A(this, e, t), le(e) ? e === O || e == null || e === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : e !== this._$AH && e !== be && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? de(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = A(this, e, t, 0), a = !le(e) || e !== this._$AH && e !== be, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = A(this, r[n + o], t, o), s === be && (s = this._$AH[o]), a ||= !le(s) || s !== this._$AH[o], s === O ? e = O : e !== O && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
...
Me?.(we, Ee), (re.litHtmlVersions ??= []).push("3.3.2");
var Ne = (e, t, n) => {
...
function bn(e) {
	...
	let t = yn(e[0].unit);
	if (!e.some((e) => yn(e.unit) !== t)) return;
	let n = e.filter((e) => yn(e.unit) === t), r = e.filter((e) => yn(e.unit) !== t);
...
function Cn(e) {
	...
	if (!xn(e)) return [e, []];
	let [n, r] = Sn(e), i = [], a = [];
	for (let t of e) t.id === n.id ? i.push(t) : t.id === r.id ? a.push(t) : vn(t, n) <= vn(t, r) ? i.push(t) : a.push(t);
	return [i, a];
}
function wn(e, t, n, r) {
...
function Tn(e) {
	...
	return t.flatMap((e, t) => {
		let [n, r] = e.key === "group:boolean" ? [e.series, []] : Cn(e.series), i = 28 + t * rn, a = wn(e.key, "left", n, i);
		return r.length > 0 ? [a, wn(e.key, "right", r, i)] : [a];
	});
}
function En(e, t, n, r) {
	let i = e.map((e) => ({
...
function Ln(e, t, n, r) {
	...
	let i = String(e);
	return In.has(i.toLowerCase()) ? "var(--better-history-muted-color, var(--secondary-text-color, #888))" : (n.has(i) || n.set(i, Jt[(r + n.size) % Jt.length]), n.get(i));
}
function Rn(e, t) {
...
var Xn = 60 * 1e3, L = 60 * Xn, R = 24 * L, Zn = [
	10 * Xn,
	15 * Xn,
	20 * Xn,
	30 * Xn,
...
function ar(e, t, n, r = !1, i = 12, a = !0) {
	let o = { extendStairToEnd: a }, s = { extendColumnToEnd: a }, c = Tn(ir(e, t, n)), l = new Set(c.map((e) => e.graphKey)).size, u = fn(l), d = e.filter((e) => e.valueType !== "number" && e.valueType !== "boolean").length, f = $n(n.start, n.end, i), p = n.end - n.start;
	return {
		allSeries: e,
		visibleSeries: t,
		timeBounds: n,
		...
		plotBottom: u,
		chartHeight: Rn(u, d),
		numericLines: zn(t, c, n, o),
		numericColumns: Wn(t, c, n, s),
		segments: Gn(t, u, n),
		heatingAreas: r ? [] : jn(t, c, n),
		yAxisLabels: Kn(c),
		xAxisLabels: f.map((e) => ({
			x: F(e.time, n),
			label: er(e.time, p),
...
function ur(e, t) {
	let n = t - 10, r = lr(t), i = e.ticks.length <= r ? e.ticks : sn(e.min, e.max, r), a = e.ticks === i ? e.precision : Math.max(e.precision, un(i));
	return i.map((t) => ({
...
function fr(e, t = 12, n = 180) {
	...
	for (let t = 0; t < l.length; t++) {
		let s = l[t], u = e.numericScales.filter((e) => e.graphKey === s), d = u.find((e) => e.axis === "left") ?? u[0], f = u.find((e) => e.axis === "right"), p = new Set(u.flatMap((e) => [...e.ids])), m = e.allSeries.filter((e) => (e.valueType === "number" || e.valueType === "boolean") && rr(e) === s), h = e.visibleSeries.filter((e) => p.has(e.id)), g = t === 0 ? [...h, ...o] : h, _ = dr(t === 0 ? [...m, ...a] : m, g, t), v = _.visibleSeries.filter((e) => e.valueType !== "number" && e.valueType !== "boolean"), y = v.length, ee = 28 + n + 16 + 6, te = y > 0 ? 22 + y * 14 : 0, ne = 28 + n + te + 18, b = ne + 16, re = ur(d, n), x = f ? ur(f, n) : [], S = u.map((e) => ({
			...e,
			top: 28,
			height: n
		...
		r.push({
			...
			svgHeight: ne,
			canvasHeight: b,
			lines: or(_.visibleSeries, S, i, { extendStairToEnd: e.extendStairToEnd }, n),
			columns: sr(_.visibleSeries, S, i, n, { extendColumnToEnd: e.extendStairToEnd }),
			segments: cr(v, ee, i),
			yLabels: re,
			rightYLabels: x,
			xLabels: c,
			heatingAreas: e.heatingAreas.length > 0 ? jn(e.visibleSeries, S, i) : []
		});
	}
	return r;
}
...
function Fr(e, t, n, r, i, a) {
	let o = Er(e.attribute), s = kr(e.entity, o), c = jr(n, e.entity, o), l = Nr(n, e.entity, o, e.unit, r), u = e.group ?? e.scaleGroup;
	return {
		id: s,
		entity: e.entity,
		attribute: o,
...
function Rr(e, t, n) {
	...
	let r = Lr(e.entity, n), i = e.scaleGroupKey.startsWith("group:") ? e.scaleGroupKey.slice(6) : void 0;
	return [e, ...xr.map((a) => {
		let o = [a], s = kr(e.entity, o), c = jr(n, e.entity, o), l = Yt[a] ?? Qt(t()), u = a === "current_temperature" || a === "temperature" ? r : void 0, d = a === "hvac_action" ? void 0 : i ?? "temperature";
		return {
			id: s,
			entity: e.entity,
			attribute: o,
...
function Vr(e) {
	...
	l = t?.series && t.series.length > 0 ? t.series.map((e, t) => Fr(e, t, n, r, s, c)) : (t?.defaultEntities ?? e.entities ?? []).map((e, t) => Ir(e, t, n, s, c)).filter((e) => e !== void 0);
	let u = l.length;
	return l = l.flatMap((e) => Rr(e, () => u++, n)), l = Br(l), {
		startDate: Tr(o),
		endDate: Tr(i),
...
function z(e, t) {
	...
	return Ur[e?.locale?.language?.split("-")[0] ?? e?.language?.split("-")[0] ?? "en"]?.[t] ?? Ur.en?.[t] ?? t;
}
var Wr = o`
  :host {
    display: flex;
...
function Si(e) {
	let t = z(e.hass, "search_entity"), n = e.entitySearch ?? "", r = n.trim() ? e.getAdditionalItems(n).filter(Ci) : [];
	return E`
...
function Ci(e) {
	return ii(e) && typeof e.id == "string" && typeof e.primary == "string";
}
function wi(e) {
...
function Ti(e, t) {
    ...
    >
      <span class="source-chip-icon">
        ${i && a ? E`<ha-icon .icon=${wi(a)}></ha-icon>` : E`<ha-icon .icon=${Di(e.valueType)}></ha-icon>`}
      </span>
...
function Ei(e) {
    ...
    >
      ...
      <label class="source-settings-field">
        <span>${z(e.hass, "group")}</span>
        <input
          class="source-settings-input"
          .value=${e.sourceSettingsGroup ?? ""}
          placeholder=${z(e.hass, "group_placeholder")}
...
function Oi(e) {
    ...
    <div class="entity-browser">
      ...
      <div class="entity-browser-list">
        ${t ? Ai(t, n, ii(r) ? r : {}, e) : E`<div class="entity-browser-empty">${z(e.hass, "no_entity_selected")}</div>`}
      </div>
    </div>
  `;
}
...
function Ai(e, t, n, r) {
	let i = Object.entries(n).sort(([e], [t]) => e.localeCompare(t)), a = i.some(([n, r]) => ii(r) ? !0 : vt(r) !== void 0 && !!bt(e, [...t, n]));
	return E`
...
function Hi(e, t) {
	let n = Ui(e, e.attributes, t.attributeSearch), r = n.slice(0, ti);
    ...
    <div class="entity-browser-search-results">
      ...
      ${n.length > r.length ? E`<div class="entity-browser-search-count">${z(t.hass, "attribute_results_limited")}</div>` : O}
    </div>
  `;
}
function Ui(e, t, n) {
	...
	if (!r) return [];
	let i = [], a = (t, n, o) => {
		if (!(o > ei)) for (let [s, c] of Object.entries(t)) {
			let t = [...n, s];
			if (ii(c)) {
				a(c, t, o + 1);
				continue;
...
var Ki = /°[CF]|[CFK]$/, qi = 60, Ji = 1e3, Yi = 24, Xi = 28, Zi = 720, V = 1e3, Qi = 18, $i = 44, ea = 12, ta = 14, na = 48, ra = .34, ia = .72, aa = 720, oa = 2, sa = [
	"current_temperature",
	"temperature",
	"hvac_action"
], ca = new Set(["current_temperature", "temperature"]), la = 5, ua = "haBetterHistory";
function da(e) {
	let t = 0;
...
function fa(e) {
	let t = Math.max(0, ...e.map((e) => da(e.value)));
	return t > 0 ? `${t + la}px` : "0px";
}
function pa(e) {
	return Ki.test(e);
}
...
var H = class extends Fe {
	...
	_syncChartSurfaceSize(e) {
		...
		if (this._measureGraphLayout(n ?? void 0, r), this._lastContentHeight > 0 && r > 0 && r === this._lastContentHeight && Math.abs(t - this._chartSurfaceHeight) > oa) return;
		this._lastContentHeight = r;
		let i = r < t - oa || t < r - oa, a = t < this._chartSurfaceHeight - oa, o = this._graphGroupRenderCache?.graphHeight ?? 180, s = this._chartSurfaceConstrained && o !== 180;
		if (i || a || s) {
	...
	_syncSurfaceHeaderOffset(e) {
		...
		let n = t.querySelector(".chart-graphs"), r = Math.round(t.getBoundingClientRect().height), i = n ? Math.round(n.offsetHeight) : 0, a = i > r - oa, o = Math.max(0, (r - i) / 2), s = e + 10 - o, c = t.style.getPropertyValue("--better-history-surface-header-offset"), l = c !== "";
	...
	_resolvedTemperatureUnit() {
		return this._resolved?.series.find((e) => e.scaleGroupKey === "group:temperature" && e.unit && pa(e.unit))?.unit;
	}
	willUpdate(e) {
		...
		if (u.some((t) => e.has(t))) {
			...
			i.showDatePicker && !this._datePickerReady && Qr().then(() => {
				this._datePickerReady = Zr(), this.requestUpdate();
	...
	_pickScaleGroup(e, t, n) {
		...
		if (e.unit) {
			...
			if (i && pa(e.unit)) return i.scaleGroupKey;
		}
		if (i) {
			let e = t.find((e) => e.valueType === "number" && e.unit !== void 0 && pa(e.unit));
	...
	_usesScaleGraphAlias(e) {
		return e.valueType === "number" && ma(ha(e)) !== void 0;
	}
	_renderSeriesFromSource(e, t, n, r) {
		...
		return {
			id: e.id,
			label: e.label,
			color: this._importedSeriesMeta.get(e.id)?.color ?? (i ? Yt[i] : void 0) ?? Qt(r),
			unit: e.unit,
			scaleGroupKey: n,
			scaleMode: "auto",
	...
	_chartData() {
		...
		}, f = this._data.debugPerformance, p = f ? N() : 0, m = ar(l, u, d, this._resolved?.disableClimateOverlay ?? !1, c, s), h = f ? N() - p : 0;
	...
	_renderGraphGroup(e) {
		let t = this._resolved?.showLegend ?? !0, n = this._resolved?.showGrid ?? !0, r = this._resolved?.showScale ?? !0, i = e.series.map((e) => e.id).join("|"), a = r ? fa(e.yLabels) : "0px", o = r ? fa(e.rightYLabels) : "0px", s = 28 + e.graphHeight, c = s + 3, l = s + 16 + 6;
		return E`
      <div class="graph-section">
        <div class="graph-row" style=${`--axis-label-gap:${la}px;--axis-left-gutter:${a};--axis-right-gutter:${o};`}>
	...
	_renderChartBody() {
      ...
      <div class="chart-surface">
        ${i ? E`
              ...
              </div>` : this._data.loading ? O : E`<div class="empty">${z(this.hass, "empty")}</div>`}
      </div>
    `;
	}
	_renderEntityPickerUI() {
		return !this._resolved?.showEntityPicker || !this._entityComponentsReady ? O : yi({
			hass: this.hass,
	...
	_renderDatePicker() {
		return !this._resolved?.showDatePicker || !this._datePickerReady ? O : $r({
			hass: this.hass,
	...
	_expandedSelectedSources(e) {
		...
		let n = typeof t.attributes.temperature_unit == "string" && t.attributes.temperature_unit !== "" ? t.attributes.temperature_unit : typeof t.attributes.unit_of_measurement == "string" && t.attributes.unit_of_measurement !== "" ? t.attributes.unit_of_measurement : void 0, r = sa.map((r) => {
			let i = bt(t, [r]), a = {
...
var ga = "haBetterHistory";
function _a(e) {
	return e?.group ?? e?.scaleGroup;
}
var U = class extends Fe {
	constructor(...e) {
	...
	_browserHistoryEntry(e = window.history.state) {
		let t = typeof e == "object" && e ? e[ga] : void 0;
		if (typeof t != "object" || !t) return;
		let n = t;
	...
	render() {
      ...
      ${yi({
			...
			sourceSettingsSourceId: this._sourceSettingsSourceId,
			sourceSettingsUnit: this._sourceSettingsSource()?.unit,
			sourceSettingsGroup: _a(this._sourceSettingsSource()),
			onSourceSettingsOpen: (e) => this._openSourceSettings(e),
			onSourceSettingsClose: () => {
				this._sourceSettingsSourceId = void 0;
			},
...
var ya = globalThis, ba = ya.ShadowRoot && (ya.ShadyCSS === void 0 || ya.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, xa = Symbol(), Sa = /* @__PURE__ */ new WeakMap(), Ca = class {
	constructor(e, t, n) {
		if (this._$cssResult$ = !0, n !== xa) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
		this.cssText = e, this.t = t;
	}
	get styleSheet() {
...
}, wa = (e) => new Ca(typeof e == "string" ? e : e + "", void 0, xa), Ta = (e, ...t) => new Ca(e.length === 1 ? e[0] : t.reduce((t, n, r) => t + ((e) => {
	if (!0 === e._$cssResult$) return e.cssText;
	if (typeof e == "number") return e;
	throw Error("Value passed to 'css' function must be a 'css' function result: " + e + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
})(n) + e[r + 1], e[0]), e, xa), Ea = (e, t) => {
	if (ba) e.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
	else for (let n of t) {
		let t = document.createElement("style"), r = ya.litNonce;
		r !== void 0 && t.setAttribute("nonce", r), t.textContent = n.cssText, e.appendChild(t);
	}
}, Da = ba ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((e) => {
	let t = "";
	for (let n of e.cssRules) t += n.cssText;
	return wa(t);
})(e) : e, { is: Oa, defineProperty: ka, getOwnPropertyDescriptor: Aa, getOwnPropertyNames: ja, getOwnPropertySymbols: Ma, getPrototypeOf: Na } = Object, Pa = globalThis, Fa = Pa.trustedTypes, Ia = Fa ? Fa.emptyScript : "", La = Pa.reactiveElementPolyfillSupport, Ra = (e, t) => e, za = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? Ia : null;
...
Symbol.metadata ??= Symbol("metadata"), Pa.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
var Ha = class extends HTMLElement {
	static addInitializer(e) {
		this._$Ei(), (this.l ??= []).push(e);
	}
	static get observedAttributes() {
	...
	static getPropertyDescriptor(e, t, n) {
		let { get: r, set: i } = Aa(this.prototype, e) ?? {
			get() {
				return this[t];
			},
			set(e) {
	...
	static _$Ei() {
		if (this.hasOwnProperty(Ra("elementProperties"))) return;
		let e = Na(this);
		e.finalize(), e.l !== void 0 && (this.l = [...e.l]), this.elementProperties = new Map(e.elementProperties);
	}
	static finalize() {
		if (this.hasOwnProperty(Ra("finalized"))) return;
		if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ra("properties"))) {
			let e = this.properties, t = [...ja(e), ...Ma(e)];
			for (let n of t) this.createProperty(n, e[n]);
		}
		let e = this[Symbol.metadata];
		if (e !== null) {
	...
	_$ET(e, t) {
		let n = this.constructor.elementProperties.get(e), r = this.constructor._$Eu(e, n);
		if (r !== void 0 && !0 === n.reflect) {
			let i = (n.converter?.toAttribute === void 0 ? za : n.converter).toAttribute(t, n.type);
			this._$Em = e, i == null ? this.removeAttribute(r) : this.setAttribute(r, i), this._$Em = null;
		}
	}
	_$AK(e, t) {
		let n = this.constructor, r = n._$Eh.get(e);
		if (r !== void 0 && this._$Em !== r) {
			let e = n.getPropertyOptions(r), i = typeof e.converter == "function" ? { fromAttribute: e.converter } : e.converter?.fromAttribute === void 0 ? za : e.converter;
			this._$Em = r;
			let a = i.fromAttribute(t, e.type);
			this[r] = a ?? this._$Ej?.get(r) ?? a, this._$Em = null;
		}
	...
	requestUpdate(e, t, n, r = !1, i) {
		if (e !== void 0) {
			let a = this.constructor;
			if (!1 === r && (i = this[e]), n ??= a.getPropertyOptions(e), !((n.hasChanged ?? Ba)(i, t) || n.useDefault && n.reflect && i === this._$Ej?.get(e) && !this.hasAttribute(a._$Eu(e, n)))) return;
			this.C(e, t, n);
		}
		!1 === this.isUpdatePending && (this._$ES = this._$EP());
	}
...
Ha.elementStyles = [], Ha.shadowRootOptions = { mode: "open" }, Ha[Ra("elementProperties")] = /* @__PURE__ */ new Map(), Ha[Ra("finalized")] = /* @__PURE__ */ new Map(), La?.({ ReactiveElement: Ha }), (Pa.reactiveElementVersions ??= []).push("2.1.2");
//#endregion
//#region node_modules/lit-html/lit-html.js
var Ua = globalThis, Wa = (e) => e, Ga = Ua.trustedTypes, Ka = Ga ? Ga.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, qa = "$lit$", W = `lit$${Math.random().toFixed(9).slice(2)}$`, Ja = "?" + W, Ya = `<${Ja}>`, G = document, Xa = () => G.createComment(""), Za = (e) => e === null || typeof e != "object" && typeof e != "function", Qa = Array.isArray, $a = (e) => Qa(e) || typeof e?.[Symbol.iterator] == "function", eo = "[ 	\n\f\r]", to = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, no = /-->/g, ro = />/g, K = RegExp(`>|${eo}(?:([^\\s"'>=/]+)(${eo}*=${eo}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), io = /'/g, ao = /"/g, oo = /^(?:script|style|textarea|title)$/i, q = ((e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
}))(1), so = Symbol.for("lit-noChange"), J = Symbol.for("lit-nothing"), co = /* @__PURE__ */ new WeakMap(), Y = G.createTreeWalker(G, 129);
function lo(e, t) {
	if (!Qa(e) || !e.hasOwnProperty("raw")) throw Error("invalid template strings array");
	return Ka === void 0 ? t : Ka.createHTML(t);
}
var uo = (e, t) => {
	let n = e.length - 1, r = [], i, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = to;
	for (let t = 0; t < n; t++) {
		let n = e[t], s, c, l = -1, u = 0;
		for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === to ? c[1] === "!--" ? o = no : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = K) : (oo.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = K) : o = ro : o === K ? c[0] === ">" ? (o = i ?? to, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? K : c[3] === "\"" ? ao : io) : o === ao || o === io ? o = K : o === no || o === ro ? o = to : (o = K, i = void 0);
		let d = o === K && e[t + 1].startsWith("/>") ? " " : "";
		a += o === to ? n + Ya : l >= 0 ? (r.push(s), n.slice(0, l) + qa + n.slice(l) + W + d) : n + W + (l === -2 ? t : d);
	}
	return [lo(e, a + (e[n] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
}, fo = class e {
	constructor({ strings: t, _$litType$: n }, r) {
		let i;
		this.parts = [];
		let a = 0, o = 0, s = t.length - 1, c = this.parts, [l, u] = uo(t, n);
		...
		for (; (i = Y.nextNode()) !== null && c.length < s;) {
			if (i.nodeType === 1) {
				if (i.hasAttributes()) for (let e of i.getAttributeNames()) if (e.endsWith(qa)) {
				...
				if (oo.test(i.tagName)) {
					...
					if (t > 0) {
						...
						for (let n = 0; n < t; n++) i.append(e[n], Xa()), Y.nextNode(), c.push({
							type: 2,
							index: ++a
						});
						i.append(e[t], Xa());
			...
			} else if (i.nodeType === 8) if (i.data === Ja) c.push({
				type: 2,
				index: a
			});
			else {
...
function po(e, t, n = e, r) {
	if (t === so) return t;
	let i = r === void 0 ? n._$Cl : n._$Co?.[r], a = Za(t) ? void 0 : t._$litDirective$;
	return i?.constructor !== a && (i?._$AO?.(!1), a === void 0 ? i = void 0 : (i = new a(e), i._$AT(e, n, r)), r === void 0 ? n._$Cl = i : (n._$Co ??= [])[r] = i), i !== void 0 && (t = po(e, i._$AS(e, t.values), i, r)), t;
}
var mo = class {
	constructor(e, t) {
		this._$AV = [], this._$AN = void 0, this._$AD = e, this._$AM = t;
	...
	u(e) {
		...
		for (; s !== void 0;) {
			if (a === s.index) {
				let t;
				s.type === 2 ? t = new ho(i, i.nextSibling, this, e) : s.type === 1 ? t = new s.ctor(i, s.name, s.strings, this, e) : s.type === 6 && (t = new bo(i, this, e)), this._$AV.push(t), s = n[++o];
			}
	...
	_$AI(e, t = this) {
		e = po(this, e, t), Za(e) ? e === J || e == null || e === "" ? (this._$AH !== J && this._$AR(), this._$AH = J) : e !== this._$AH && e !== so && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? $a(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
		return this._$AA.parentNode.insertBefore(e, this._$AB);
	}
	...
	_(e) {
		this._$AH !== J && Za(this._$AH) ? this._$AA.nextSibling.data = e : this.T(G.createTextNode(e)), this._$AH = e;
	}
	$(e) {
		let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = fo.createElement(lo(n.h, n.h[0]), this.options)), n);
		if (this._$AH?._$AD === r) this._$AH.p(t);
		else {
			let e = new mo(r, this), n = e.u(this.options);
			e.p(t), this.T(n), this._$AH = e;
		}
	}
	_$AC(e) {
		let t = co.get(e.strings);
		return t === void 0 && co.set(e.strings, t = new fo(e)), t;
	}
	k(t) {
		Qa(this._$AH) || (this._$AH = [], this._$AR());
		let n = this._$AH, r, i = 0;
		for (let a of t) i === n.length ? n.push(r = new e(this.O(Xa()), this.O(Xa()), this, this.options)) : r = n[i], r._$AI(a), i++;
		i < n.length && (this._$AR(r && r._$AB.nextSibling, i), n.length = i);
	}
	_$AR(e = this._$AA.nextSibling, t) {
		for (this._$AP?.(!1, !0, t); e !== this._$AB;) {
			let t = Wa(e).nextSibling;
			Wa(e).remove(), e = t;
		}
	}
	setConnected(e) {
	...
	_$AI(e, t = this, n, r) {
		let i = this.strings, a = !1;
		if (i === void 0) e = po(this, e, t, 0), a = !Za(e) || e !== this._$AH && e !== so, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = po(this, r[n + o], t, o), s === so && (s = this._$AH[o]), a ||= !Za(s) || s !== this._$AH[o], s === J ? e = J : e !== J && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
	...
	_$AI(e, t = this) {
		if ((e = po(this, e, t, 0) ?? J) === so) return;
...
}, xo = Ua.litHtmlPolyfillSupport;
xo?.(fo, ho), (Ua.litHtmlVersions ??= []).push("3.3.3");
var So = (e, t, n) => {
	let r = n?.renderBefore ?? t, i = r._$litPart$;
	if (i === void 0) {
		let e = n?.renderBefore ?? null;
		r._$litPart$ = i = new ho(t.insertBefore(Xa(), e), e, void 0, n ?? {});
	}
	return i._$AI(e), i;
}, Co = globalThis, X = class extends Ha {
	constructor() {
		super(...arguments), this.renderOptions = { host: this }, this._$Do = void 0;
	}
	createRenderRoot() {
...
X._$litElement$ = !0, X.finalized = !0, Co.litElementHydrateSupport?.({ LitElement: X });
var wo = Co.litElementPolyfillSupport;
wo?.({ LitElement: X }), (Co.litElementVersions ??= []).push("4.2.2");
//#endregion
...
var Z = "en", Oo = new Set([
	...
	"pt",
	"zh"
]), ko = { "common.loading": "ui.common.loading" }, Ao = {}, jo = {};
function Mo(e) {
	return new URL(
		/* @vite-ignore */
		`translations/${e}.json`,
...
async function Po(e) {
	if (!Ao[e]) return jo[e] || (jo[e] = fetch(Mo(e)).then((e) => {
		if (!e.ok) throw Error(`HTTP ${e.status}`);
		return e.json();
	}).then((t) => {
		Ao[e] = t;
	}).catch((t) => {
		console.warn(`[a-better-history-card] Failed to load ${e} translations:`, t), Ao[e] = {};
	}).finally(() => {
		delete jo[e];
	})), jo[e];
}
async function Fo(e, t) {
	...
	return await Promise.all(r.map((e) => Po(e))), n;
}
function $(e, t, n) {
	let r = ko[t], i = e?.localize;
	if (r && i) {
		let e = i(r);
		if (e) return e;
	}
	return Ao[Q(e, n)]?.[t] ?? Ao[Z]?.[t] ?? No(t);
}
//#endregion
...
customElements.get("abh-history-dialog") || customElements.define("abh-history-dialog", Io);
//#endregion
...
//#endregion
//#region src/const.ts
var Ro = "A Better History Card", zo = "custom:a-better-history-card", Bo = "a-better-history-card", Vo = "a-better-history-card-history", Ho = "a-better-history-card-editor", Uo = "custom:a-better-history-button-card", Wo = "a-better-history-button-card", Go = "a-better-history-button-card-editor";
//#endregion
...
var qo = class extends X {
	...
	static getConfigElement() {
		return document.createElement(Ho);
	}
  ...
  `;
	...
	setConfig(e) {
		let t = e;
		!t.entities?.length && t.series?.length, this._config = { ...Lo(t) }, this._controlsVisible = this._config.show_controls ?? !0, this._graphVisible = void 0;
	}
	updated() {
...
var Yo = class extends X {
	...
	static getConfigElement() {
		return document.createElement(Go);
	}
	static getStubConfig(e) {
		let t = e?.states ?? {}, n = Object.keys(t).find((e) => /^sensor\.[^.]*temperature/.test(e) || e.startsWith("climate.")) ?? Object.keys(t).find((e) => e.startsWith("sensor.") && !isNaN(Number(t[e]?.state)));
		return {
...
var us = class extends X {
  ...
  `;
	...
	setConfig(e) {
		this._config = { ...Lo(e) }, this._editingHours || (this._hoursDraft = this._hoursDisplayValue());
		let t = this._tabs();
